...
> 前言：
> 本文主要是有关前端方面知识按照 XX 目前的认知进行的收集、归类、概括和整理，涵盖『前端理论』与『前端实践』两方面。本文会告诉你前端需要了解的知识**大致有什么**，但具体你要学什么，还是要**靠自己**。
> 
> 初衷。写这篇文章主要有以下几个初衷：
...
本文大多讨论的是有哪些知识点，至于如何学习与应用这些知识点，敬请期待我之后的一系列文章，目前已完成一些雏形，仅供试阅：
